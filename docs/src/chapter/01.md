...
```@raw html
<img src="https://github.com/MizutoKadowaki0312/Documenter_website/blob/main/docs/src/chapter/images/desk.png" height = "40%" width="40%">
```
```@raw html
<img src="https://github.com/MizutoKadowaki0312/Documenter_website/blob/main/docs/src/chapter/images/desk02.png" height = "40%" width="40%">
```

↑ 普段の作業環境．プログラミングに関する書籍と物理の専門書，論文がぐちゃぐちゃに置いてあります．(8)